...
public class Templates2 extends BaseClass {
	...
	@FindBy(xpath = "//button[@title='Mail Merge']")
	WebElement mailMergeBtn;
	
	@FindBy(xpath="//div[@title='User.First Name']")
	WebElement mailMergeUserFirstName;
	
	@FindBy(xpath="//div[@title='User.Last Name']")
	WebElement mailMergeUserLastName;
