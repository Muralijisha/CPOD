...
public class SalesforceCustomerPortal extends BaseClass {
	...
	@FindBy(xpath="//div[contains(@class,'jconfirm-box jconfirm-hilight')]")
	...
	public void uploadCRMFile_MyList() throws InterruptedException {
		...
		String cadencename=prop.getProperty("saveAsFileName")+"')]/parent::td/./preceding-sibling::td/input";
		...
		continueBtn.click();
		Thread.sleep(25000);
	WebElement checkboxes = driver.findElement(By.xpath("(//img[@title='Check All'])[1]"));
		
		Actions ac3=new Actions(driver);
			ac3.moveToElement(checkboxes).click().build().perform();
			Thread.sleep(8000);
			WebElement yesButton = driver.findElement(By.xpath("//div[@id='checkAllDiv']"));
			ac3.moveToElement(yesButton).click().build().perform();
