...
import com.at.Cadencemodule.TaskTouch;
...
import io.qameta.allure.Description;
	...
	public class CadenceWorkflowTest extends BaseClass {
		...
		public void cadenceCreationTest() throws Exception {
			...
			pd.createCallTouch();
			Thread.sleep(5000);
			linkedIntouch.createLinkedlnTouch();
			socialtouch.createOtherTouch();
			tasktouch.createOtherTouch();
			automailtouch.createAutomailTouch(); 
			replyemail.createAutomailTouch();
